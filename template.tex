...
Different applications tolerate varying levels of inconsistency in the link-state. Ethane \cite{koponen2010onix}, which provides a flow managment interface, prefers the availibility of the link-state to better install flows on the switches.
