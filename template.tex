...
Each of the SDN controllers have at least two methods for maintaining network state which fall into the categories of a transactional data store, a coordination service with strong consistency gurarantees, and an eventually consistent system with high availibility. 
...
The controllers aim to maintain an accurate view of the network using these systems, which each have tradeoffs in their consistency and availibility charateristics; these make them better suited for keeping track of differnt parts of the network.
