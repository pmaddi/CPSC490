...
These policy changes tend to be rare, only occuring when the application needs to revise a routing descision. Therefore, the controller tends to store these data in a transactional database providing strong consistncy.
