...
The main objects that the SDN controllers must track are the topological network elements and the controller nodes. 
topo inventiry and node inventory
\cite{network2015topologies}
\subsection*{Topology}
