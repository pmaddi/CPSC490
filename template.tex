...
How the inventory is managed depends on both the application and the scale of the network. When the NIB is small enough that it fits in memory, it can be kept in either a transactional database or in the
