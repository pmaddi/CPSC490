...
The CAP theorem \cite{brewer2000towards} shows that we cannot have consistency over the whole virtual network as well as complete availibility and network partition tolerance.
